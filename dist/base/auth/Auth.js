...
var Auth = function (_EventResource) {
  _inherits(Auth, _EventResource);
...
Auth.EVENTS = ['beforeConnect', 'beforeFetchToken', 'beforeRefreshToken', 'checkToken', 'authError', 'connected', 'error'];
