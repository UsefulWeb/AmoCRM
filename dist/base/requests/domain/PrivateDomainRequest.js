...
var _DomainRequest2 = require( './DomainRequest' ),
  ...
  _DomainRequest3 = _interopRequireDefault( _DomainRequest2 );
...
var _PrivateDomainResponseHandler = require( '../../responseHandlers/PrivateDomainResponseHandler' ),
  ...
  _PrivateDomainResponseHandler2 = _interopRequireDefault( _PrivateDomainResponseHandler );
  ...
  _createClass( PrivateDomainRequest, [ {
    ...
    value: function requestWithFormData( url ) {
      var data = arguments.length > 1 && arguments[ 1 ] !== undefined ? arguments[ 1 ] : {},
        ...
        headers = _extends({}, this.getDefaultHeaders( options ), {
          'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
        }),
        encodedData = _qs2.default.stringify( data ),
