...
var _promiseQueue = require( 'promise-queue' ),
  ...
  _promiseQueue2 = _interopRequireDefault( _promiseQueue );
...
var _HTTPRequest = require( '../common/HTTPRequest' ),
  ...
  _HTTPRequest2 = _interopRequireDefault( _HTTPRequest );

var _DomainResponseHandler = require( '../../responseHandlers/DomainResponseHandler' ),

  _DomainResponseHandler2 = _interopRequireDefault( _DomainResponseHandler );

var _EventResource2 = require( '../../EventResource' ),

  _EventResource3 = _interopRequireDefault( _EventResource2 );
  ...
  _createClass( DomainRequest, [ {
    ...
    value: function request( url ) {
      var data = arguments.length > 1 && arguments[ 1 ] !== undefined ? arguments[ 1 ] : {},
        ...
        options = arguments.length > 3 && arguments[ 3 ] !== undefined ? arguments[ 3 ] : {},

        encodedData = this.encodeData( url, data, method, options ),
    ...
    value: function handleResponse( _ref ) {
      var rawData = _ref.rawData,
        ...
        responseHandlerClass = this.constructor.responseHandlerClass,
    ...
    value: function createRequest( url ) {
      var encodedData = arguments.length > 1 && arguments[ 1 ] !== undefined ? arguments[ 1 ] : '',
        method = arguments.length > 2 && arguments[ 2 ] !== undefined ? arguments[ 2 ] : 'GET',
        headers = arguments.length > 3 && arguments[ 3 ] !== undefined ? arguments[ 3 ] : {},
