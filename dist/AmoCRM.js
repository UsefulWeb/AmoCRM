...
var _AmoConnection = require( './base/AmoConnection' ),
  ...
  _AmoConnection2 = _interopRequireDefault( _AmoConnection );

var _ResourceFactoryBuilder = require( './base/ResourceFactoryBuilder' ),

  _ResourceFactoryBuilder2 = _interopRequireDefault( _ResourceFactoryBuilder );

var _ConnectionRequest = require( './base/requests/ConnectionRequest' ),

  _ConnectionRequest2 = _interopRequireDefault( _ConnectionRequest );
