...
| Объект | Описание |
|-------|----------|
|crm.Lead   |Множественные операции|
|lead = new crm.Lead|Работа с объектом сделки|
|lead.contacts|Работа с контактами сделки|
|lead.company|Работа с компанией сделки|
|lead.notes|Работа с примечаниями сделки|
|lead.tasks|Работа с задачми сделки|
|crm.Lead.Field|Работа с дополнительными полями сделки|
